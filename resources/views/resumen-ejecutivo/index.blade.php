    ...
    <div class="row mb-4">
        ...
        <div class="col-md-4">
            ...
            <div class="card shadow-sm border-0 mb-3 rounded-3">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <div>
                            <h6 class="text-muted text-uppercase fw-bold ls-1 mb-1">Refrendos</h6>
                            <h4 class="fw-bold text-dark mb-0" id="kpi-refrendo">$ 0.00</h4>
                            <small class="text-muted" id="kpi-refrendo-contratos">0 Contratos</small>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="card shadow-sm border-0 mb-3 rounded-3">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="icon-shape bg-light-info text-info me-3">
                            <i class="bi bi-box-arrow-right"></i>
                        </div>
                        <div>
                            <h6 class="text-muted text-uppercase fw-bold ls-1 mb-1">Desempeños</h6>
                            <h4 class="fw-bold text-dark mb-0" id="kpi-desempeno">$ 0.00</h4>
                            <small class="text-muted" id="kpi-desempeno-contratos">0 Contratos</small>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function updateDashboard(data) {
            ...
            document.getElementById('kpi-refrendo').innerText = formatter.format(data.refrendosData.prestamo);
            document.getElementById('kpi-refrendo-contratos').innerText = `${data.refrendosData.contratos} Contratos`;

            document.getElementById('kpi-desempeno').innerText = formatter.format(data.desempenosData.prestamo);
            document.getElementById('kpi-desempeno-contratos').innerText = `${data.desempenosData.contratos} Contratos`;
